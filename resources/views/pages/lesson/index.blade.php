...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Media Belajar</h2>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/">Home</a>
                        </li>
                        <li class="breadcrumb-item">Media Belajar
                        </li>
                        <li class="breadcrumb-item active">Data Media Belajar
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Data-data Media Belajar</h4>
                </div>
        ...
        <div class="modal-content">
            ...
            <form id="formAddLesson">
                <div class="modal-body" style="max-height: calc(100vh - 200px); overflow-y: auto;">
                    <div class="row">
                        <input type="hidden" id="post_category_id" value="2">
                        <div class="col-12">
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.btn-update', function () {
            ...
            $.ajax({
                url: "{{ route('get-one-lesson') }}",
                type: "GET",
                data: {
                    'query': id
                },
                success: function (data) {
                    var formEditContent = $("#formUpdateLesson");
        ...
        $("#formUpdateLesson").submit(function (e) {
            e.preventDefault();
