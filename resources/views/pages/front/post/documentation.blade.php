...
<section class="py-48 h-[700px] text-white relative"
    ...
    <div class="w-[90%] lg:w-[80%] mx-auto px-6 text-center">
        <h1 class="text-4xl md:text-5xl font-bold mt-10 mb-6">
            <span class="text-yellow-300">Dokumentasi</span>
        </h1>
...
<section class="py-24 bg-white">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="flex justify-center mb-12">
            <input id="searchInput" type="text" placeholder="Cari Documentasi..."
        ...
        <div id="documentationContainer">
            @include('partials.documentation-list', ['documentations' => $documentations])
        </div>
    </div>
</section>
...
$(document).ready(function () {
    ...
    function fetchLessons(query = '', pageUrl = "{{ route('documentation-front') }}") {
        $.ajax({
            url: pageUrl,
            method: 'GET',
            data: { search: query },
            beforeSend: function() {
                $('#documentationContainer').fadeOut(200, function() {
                    $(this).html(`
